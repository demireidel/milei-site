...
export const researchPapers: ResearchPaper[] = [
  {
    ...
    title: "Minimum Viable Scale and Local Activation with Increasing Returns to Scale and Endogenous Labor Supply",
    authors: "Javier Milei & Demian Reidel",
    year: "2026",
    abstract: "Modelo Ramsey con oferta laboral endógena y tecnología CES homogénea de grado θ. En el régimen de pliegue (θ > 1 y σ < 1), la condición de Euler estacionaria colapsa el sistema a una función escalar diagnóstica G(r;D). La productividad marginal reducida del capital tiene forma de joroba, generando una escala mínima viable en forma cerrada. Por debajo de ese umbral no existe estado estacionario interior. Por encima, coexisten típicamente dos estados estacionarios — uno de baja y otro de alta productividad — separados por una brecha de hasta 7× en producto y 6× en capital. La teoría dinámica local establece activación, histéresis y recuperación en dos umbrales.",
    keyResults: [
      "Diagnóstico escalar: el sistema 3D colapsa a encontrar ceros de una sola función G(r;D) — un atajo que permite analizar la existencia de equilibrios de forma cerrada",
      "Escala mínima viable: L_min = (D / φ_K^max)^(1/(θ-1)) — por debajo de esta escala, no existe ningún equilibrio de crecimiento sostenible",
      "Dos mundos: con rendimientos a escala de apenas θ = 1.25, el estado estacionario alto tiene 7× más producto, 6× más capital y 9× más consumo que el bajo — ambos coexisten como equilibrios válidos",
      "Amplificador de cuña: la elasticidad de L_min respecto de la cuña es 1/(θ−1) — con θ = 1.25, cada 1% de aumento en la cuña regulatoria amplifica la escala mínima en 4%",
      "Histéresis y recuperación bidimensional: salir de la trampa de baja productividad requiere simultáneamente reducir la cuña por debajo de D_SN Y tener suficiente capital en la región de activación — ninguna condición sola es suficiente",
    ],
  ...
  },
  {
    ...
    title: "When Regulation Kills Growth",
    subtitle: "A Theoretical and Practical Framework Against Scale-Fragmenting Regulation",
    authors: "Javier Milei & Demian Reidel",
    year: "2026",
    abstract: "Los debates regulatorios en sectores con rendimientos crecientes saltan demasiado rápido del poder de mercado a la intervención estructural. Este paper demuestra que ese salto es peligroso. Construye un Scale Impact Assessment (SIA) operacional — un protocolo de evaluación que define la unidad productiva, mide el headroom desde el pliegue, mapea cada remedio en cuatro canales económicos (alivio de markup, destrucción de complementariedades, presión de cuña y escala retenida) y emite una decisión transparente: pasa, falla, indeterminado o dominado. El caso Google Search 2025 ilustra el framework sobre un expediente real.",
    keyResults: [
      "Scale Impact Assessment (SIA): protocolo práctico de 6 pasos para que tribunales y reguladores evalúen si un remedio es fold-safe antes de fragmentar un sector",
      "Cuatro canales económicos: cada remedio se descompone en markup relief (m_r), complementarity destruction (c_r), wedge pressure (u_r) y retained scale (ℓ_r) — las etiquetas legales pueden engañar, los canales económicos no",
      "Los markups no son un defecto del sistema — son el mecanismo que sostiene la operación bajo rendimientos crecientes. Reducirlos vía conducta baja la escala mínima; fragmentar la unidad productiva la sube",
      "Regla de decisión bajo irreversibilidad: (i) definir la unidad productiva, (ii) aplicar el SIA y eliminar todo remedio que falle o esté dominado, (iii) solo entonces hacer el balanceo de bienestar con los remedios admisibles",
      "Caso Google Search 2025: el tribunal rechazó la divestiture de Chrome y eligió remedios de conducta — el SIA clasifica la divestiture como 'no demostrada fold-safe' bajo supuestos conservadores",
    ],
